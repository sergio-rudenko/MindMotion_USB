...
/* Exported functions ------------------------------------------------------- */
extern const uint8_t USB_VirtualComPort_DeviceDescriptor[VIRTUAL_COM_PORT_SIZ_DEVICE_DESC];
extern const uint8_t USB_VirtualComPort_ConfigDescriptor[VIRTUAL_COM_PORT_SIZ_CONFIG_DESC];
...
extern uint8_t USB_VirtualComPort_StringDescriptor[128];
